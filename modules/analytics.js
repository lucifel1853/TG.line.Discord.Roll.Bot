...
try {
	...
	function parseInput(inputStr) {
		...
		if (trigger.match(/^ccb$|^cc$|^ccn[1-2]$|^cc[1-2]$|^dp$|^成長$/) != null && mainMsg[1] <= 1000) { //ccb指令開始於此
			if (trigger == 'ccb' && mainMsg[1] <= 99) return exports.coc.coc6(mainMsg[1], mainMsg[2]);

			//DevelopmentPhase幕間成長指令開始於此
			if ((trigger == 'dp' || trigger == '成長') && mainMsg[1] <= 1000) return exports.coc.DevelopmentPhase(mainMsg[1], mainMsg[2]);
			//cc指令開始於此
